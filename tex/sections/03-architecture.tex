...
\begin{figure*}[t]
  ...
  \caption{DARE hardware organization: (a) shared PEA/VCU hierarchy; (b) mode-controlled address generation, $4\times9$ lane mapping, replay, and segmented reduction around the same 36 lanes; and (c) the unchanged FP16 VCU path.}
  \label{fig:dare_arch}
\end{figure*}
